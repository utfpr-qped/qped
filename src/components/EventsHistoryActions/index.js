...
export const ExportCard = ({ handleExport }) => {
  return (
    <div className="EventsHistoryActions">
      <div className="desc">
        <p>Exporte um arquivo contendo um histórico completo das atividades resolvidas.</p>
      </div>
...
export const ImportCard = () => {
  return (
    <div className="EventsHistoryActions">
      <div className="desc">
        <p>Lorem ipsum dolor sit, provident placeat facilis earum atque illum fuga veniam! Sed totam inventore aut iure.</p>
      </div>
      <div className="actions">
        <div className="btn btn-dark">Importar</div>
      </div>
    </div>
  );
}
